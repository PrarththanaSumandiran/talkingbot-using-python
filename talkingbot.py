...
while True:
    ...
    if user_input == "hello":
        ...
        talk_function("My name is Natalya");

    elif user_input == "what is your current work":
        talk_function("Learning Python");

    elif user_input == "what is your favourite game":
        talk_function("Cricket is my favourite game");
    ...
    elif user_input == "please do an divition":
